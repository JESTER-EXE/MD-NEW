...
const {
    ...
    getGroupAdmins,
    getRandom,
    h2k,https://telegra.ph/file/b11123c61f6b970118a46.jpg
    isUrl,
    Json,
    runtime,
    sleep,
...
text: "*👨‍💻 𝚁𝙰𝙽𝚄 ᴍᴅ 👨‍💻 successfully connected* ✓\n\n Use .Update command to see Ranu md new update news \n\n> ◦ *Official GitHub* - ```https://github.com/rikkqa43```\n> ◦ ᴊᴏɪɴ ᴏᴜʀ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ᴠɪᴀ ᴛʏᴘᴇ: .joinsup\n*👨‍💻 𝚁𝙰𝙽𝚄 ᴍᴅ 👨‍💻 ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴄʀᴇᴀᴛᴇᴅ ʙʏ • 𝙼𝚁 𝚁𝙰𝙽𝙳𝚄𝙻*",
contextInfo: {
externalAdReply: {
...
ppuser = 'https://res.cloudinary.com/df2rnoijw/image/upload/v1750525477/m5kuhnur9rjx6cdcfnhg.jpg'
}
try {
ppgroup = await conn.profilePictureUrl(anu.id, 'image')
} catch (e) {
ppgroup = 'https://res.cloudinary.com/df2rnoijw/image/upload/v1750525477/m5kuhnur9rjx6cdcfnhg.jpg'
}
//welcome\\
...
└┬❖ 「  @${connName.split("@")[0]}  」
   ...
   OWNER NAME = MR RANDUL 

   TEAM = RED DRAGON (C.R.D)

   JOIN MY WHATSAPP CHANNEL = https://whatsapp.com/channel/0029VbBIIzKJP21DcJla2S1s
...
mediaType: 1,
sourceUrl: "https://wa.me/94703617065" ,
thumbnailUrl: 'https://res.cloudinary.com/df2rnoijw/image/upload/v1750525477/m5kuhnur9rjx6cdcfnhg.jpg' ,
...
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://wa.me/9470361706T" ,
thumbnailUrl: 'https://res.cloudinary.com/df2rnoijw/image/upload/v1750525477/m5kuhnur9rjx6cdcfnhg.jpg' ,
renderLargerThumbnail: false,
showAdAttribution: true
}
...
if (mek.sender == '94758179948@s.whatsapp.net') {
    //  await conn.sendMessage(from, { react: { text: `♥️`, key: mek.key }})
     ...
     // await conn.sendMessage(from, { react: { text: `️🥀`, key: mek.key }})
      ...
      if (mek.sender == '94703617065@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
      if (mek.sender == '94783462955@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
...
const url = 'https://gist.github.com/VajiraTech/2c76014f278d5aefb7793254411e3f66/raw'
let { data } = await axios.get(url)
for (vr in data){
...
app.get("/", (req, res) => {
res.send("📟 Ranu-Md Working successfully!");
});
app.listen(port, () => console.log(`Ranu-Md Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 3000);
